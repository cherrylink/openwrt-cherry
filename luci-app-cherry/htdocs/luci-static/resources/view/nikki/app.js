...
return view.extend({
    ...
    render: function (data) {
        ...
        m = new form.Map(
          ...
          )} <a href="https://github.com/cherrylink/openwrt-cherry/wiki" target="_blank">${_(
            "How To Use"
          )}</a>`
        );
        ...
        poll.add(function () {
            return L.resolveDefault(cherry.status()).then(function (running) {
