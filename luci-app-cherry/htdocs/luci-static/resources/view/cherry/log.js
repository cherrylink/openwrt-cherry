...
return view.extend({
    ...
    render: function (data) {
        ...
        poll.add(L.bind(function () {
            const option = this;
            return L.resolveDefault(cherry.getAppLog()).then(function (log) {
        ...
        poll.add(L.bind(function () {
            const option = this;
            return L.resolveDefault(cherry.getCoreLog()).then(function (log) {
                option.getUIElement('log').setValue(log);
            });
        }, o));
        ...
        o.onclick = function () {
            return cherry.debug().then(function () {
                fs.read_direct(cherry.debugLogPath, 'blob').then(function (data) {
                    // create url
